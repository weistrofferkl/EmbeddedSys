...
int i2c_master_writeBit(int device, unsigned int addr, unsigned int bitNum, unsigned char data[], REFERENCE_PARAM(struct r_i2c, i2c_master));
int i2c_master_writeBits(int device, unsigned int addr, unsigned int bitStart, unsigned int length, unsigned char data[], REFERENCE_PARAM(struct r_i2c, i2c_master));
int i2c_master_readBits(int device, unsigned int addr, unsigned int bitStart, unsigned int length, unsigned char data[], REFERENCE_PARAM(struct r_i2c, i2c_master));
#endif
